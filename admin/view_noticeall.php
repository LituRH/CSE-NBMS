...
echo "<tr class='r$m'><td>$row[0]</td><td><a href=page2ad.php?id=$row[0]>$row[1]</a></td><td>$row[2]</td><td>$row[4]</td><td>$row[6]</td><td><a href=deletenotice_admin.php?id=$row[0]>Delete</a>/<a href=updatenotice_admin.php?id=$row[0]>Update</a></td></tr>";
}
