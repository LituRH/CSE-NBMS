		...
		<table border="0" cellpadding="5" cellspacing="12" align="center">
           ...
           {			
			...
			<tr>
				...
				<td><?php echo $files;?><input type="file"  name="file"  size="70" id="pass"  /></td>
			</tr>
				...
				<td colspan="2">
					...
					<br />
					<center>
					<input type="submit" class="btnLogin" name="btnUpdate" value="Update" />&nbsp;&nbsp;<input type="submit" class="btnLogin" name="btnCancel" value="Cancel" />
					</center>
				</td>
			</tr>
		</table>
