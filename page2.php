      ...
      <tr>
       <td valign="top" height="100px" align="center"  class="hed" bgcolor="#FFFFFF"><img src="images/images.jpg" width="100px" height="100px"></td>
     	<td colspan="2" height="100px" class="hed1" bgcolor="#FFFFFF"><br/>&nbsp; &nbsp;&nbsp; &nbsp; Dhaka University Of Engineering & Technology <br/> &nbsp; &nbsp;&nbsp; &nbsp;Department Of Computer Science & Engineering</td>
           ...
           <tr height="30px">
     	<td valign="top" colspan="2" align="left" class="memo"> <br/><b>Memo No:&nbsp;</b><?php echo $memo; ?></td>
        <td valign="top" align="center" class="dat"><br/><b>Date:</b><?php echo $dat; ?></td>
      </tr>
           <tr>
     	<td valign="top" colspan="3"><u> <br/><h2><?php echo $title; ?></h2></u><b><?php echo $texts; ?></b></td>
      </tr>
       <tr>
        <td   height="30px" align="left"colspan="1"valign="top"><b>Attach Files :</b> <?php if($files==" "){ echo "No Attach Files"; }else { echo "<a href='admin/upload/$files'> Download </a>";}?></td>
        <td valign="top" colspan="2" align="right"> <button onclick="printContent('div1')"><b>Print Content</b></button></td>
      </tr>
     </table>
