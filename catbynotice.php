...
$back = $eu - $limit; 
$next = $eu + $limit; 
$nume = $dbo->query("select count(n_id) from notices WHERE n_cat_no= '$id'")->fetchColumn();
echo "<TABLE class='t1'>";
echo  "<tr><th>Memo No</th><th>Title</th><th>Catagory</th><th>Published Date</th><th>Details</th></tr>";
$query=" SELECT * FROM notices WHERE n_cat_no= '$id' ORDER BY id DESC   limit $eu, $limit ";
